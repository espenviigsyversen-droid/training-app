...
## Planlagte modulgrenser for v172-v177

De neste produktsporene skal følge samme kontrollerte uttrekksmønster som v164-v169. Modulnavnene er planlagte og opprettes først når den aktuelle runden implementeres.

- `domain-exercises.js`: øvelsesmodell, normalisering, validering, snapshot-regler, URL-policy og rene sammendrag.
- `exercise-library-ui.js`: gjenbrukbart øvelsesbibliotek, søk, valg og redigering med injiserte state-/handlingsavhengigheter.
- `workout-template-ui.js`: utvides med strukturerte styrke- og øvelsesblokker, men eier fortsatt ikke persistence.
