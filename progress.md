Warning: truncated output (original token count: 14262)
...
- **Skadesignal-innsikt v2** (v119): Innsikt har nå en egen `Skadesignal`-seksjon når det finnes smerte fra siste 7 dager. …5262 tokens truncated…ne-sone samt nivå og kunnskapsbegrensninger. Rå Markdown-/PDF-/tekniske prosjektfiler sendes ikke til modellen.
