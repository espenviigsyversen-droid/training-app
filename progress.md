...
- **Skadeoppfølging v2: Trend og frislipp** (v126): Skadesignal-kortet viser nå tydeligere frislipp-vurdering: trend, neste trygge økt, kriterier før løping/kvalitet og om hard kvalitet bør holdes igjen. Ren logikk ligger i `injuryRe…5605 tokens truncated…truktur, intensitet og tidspunkt eller merkes som generelle. Planlagte økter sender nå strukturert intervall- og estimert varighetsgrunnlag til AI.
